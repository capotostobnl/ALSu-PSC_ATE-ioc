...
/* Generated from ../O.Common/PSCtest.dbd */
...
int PSCtest_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/epics/iocs/PSCTest2";
...
/* PSCtest_registerRecordDeviceDriver */
...
static const iocshFuncDef rrddFuncDef = {
    ...
    "Example: PSCtest_registerRecordDeviceDriver pdbbase\n",
};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(PSCtest_registerRecordDeviceDriver(*iocshPpdbbase));
}
